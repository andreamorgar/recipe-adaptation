...
Original file is located at
    https://colab.research.google.com/drive/1WGWdJikRg81XDFoQzvT8axkeDoKhR00F
"""
...
glove_input_file = sst_home + 'glove.txt'
word2vec_output_file = sst_home + 'glove.txt.word2vec'
# save the model for future use with gensim library
glove2word2vec(glove_input_file, word2vec_output_file)

filename = sst_home + 'glove.txt.word2vec'
